...
import pe.edu.cibertec.DSWII_CL1SOAP_AbelPerez.exception.NotFoundException;
import pe.edu.cibertec.DSWII_CL1SOAP_AbelPerez.service.AutorService;
...
public class AutorEndPoint {
    ...
    public GetAutorResponse getAutor(@RequestPayload
        ...
        Autorws autorws = autorService.obtenerAutorId(request.getId());
        if(autorws == null)
